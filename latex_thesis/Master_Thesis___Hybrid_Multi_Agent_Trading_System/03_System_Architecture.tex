...
\textbf{LightGBM} is the tabular agent. Gradient-boosted decision trees consume a compact feature subset selected from the full candidate pool and emit a directional probability at every hourly bar. Treating each bar as an independent feature vector, it excels at exploiting shallow non-linear interactions in the high-dimensional technical panel, and it is the most reliable single performer in the system.
