...
\begin{itemize}
    ...
    \item \textbf{Broader validation.} Multiple non-overlapping out-of-sample windows, older history, and ideally order-book or sub-hourly data would turn promising evidence into a robustness claim.
\end{itemize}
