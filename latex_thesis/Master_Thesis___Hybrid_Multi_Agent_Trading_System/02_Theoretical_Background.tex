...
\vspace{3mm} 
Beyond aggregated price data, financial markets also generate more detailed information, such as limit order book (\gloss{LOB}) data, which captures the supply and demand dynamics of the market. While OHLCV data provides a compact representation of price movements, LOB data offers a more granular view of market activity and can be used to derive additional features for analysis ~\cite{tsantekidis2020using}.
\vspace{3mm}
