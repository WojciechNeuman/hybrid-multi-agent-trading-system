...
fig.tight_layout()
fig.savefig(FIGURES_DIR / 'tbm_label_distribution_vtrain7.png'); plt.show()
...
if not results_df.empty:
    ...
    fig.suptitle(
        ...
        fontweight='bold')
    fig.tight_layout()
    fig.savefig(FIGURES_DIR / 'grid_distributions_vtrain7.png'); plt.show()
...
if not results_df.empty:
    ...
    fig.suptitle('Trading parameter sensitivity (vtrain7) -- orange bar = best value',
                 fontweight='bold')
    fig.tight_layout()
    fig.savefig(FIGURES_DIR / 'grid_sensitivity_vtrain7.png'); plt.show()
...
fig.tight_layout()
fig.savefig(FIGURES_DIR / 'oos_best_equity_vtrain7.png'); plt.show()
...
v6_path = MODELS_DIR / 'lgbm_best_trading_params_vtrain6.json'
if v6_path.exists():
...
fig.savefig(FIGURES_DIR / 'wfo_equity_vtrain7.png'); plt.show()


# In[16]:


results_path = MODELS_DIR / 'lgbm_grid_results_vtrain7.csv'
...
params_path = MODELS_DIR / 'lgbm_best_trading_params_vtrain7.json'
...
def plot_trade_weeks(close_arr, idx, eq_arr, trades_df, p_up_arr, p_dn_arr,
    ...
    for fig_i in range(n_figs):
        ...
        if save_dir is not None:
            fname = save_dir / f'trade_timeline_vtrain7_{fig_i+1:03d}.png'
...
fig.tight_layout()
fig.savefig(FIGURES_DIR / 'stats_pnl_distribution_vtrain7.png', dpi=150)
plt.show()
...
fig.tight_layout()
fig.savefig(FIGURES_DIR / 'stats_exit_reasons_vtrain7.png', dpi=150)
plt.show()
...
fig.tight_layout()
fig.savefig(FIGURES_DIR / 'stats_confidence_vs_outcome_vtrain7.png', dpi=150)
plt.show()
...
fig.tight_layout()
fig.savefig(FIGURES_DIR / 'stats_hold_time_vtrain7.png', dpi=150)
plt.show()
...
fig.tight_layout()
fig.savefig(FIGURES_DIR / 'stats_time_patterns_vtrain7.png', dpi=150)
plt.show()
...
fig.tight_layout()
fig.savefig(FIGURES_DIR / 'stats_volatility_regime_vtrain7.png', dpi=150)
plt.show()
...
fig.tight_layout()
fig.savefig(FIGURES_DIR / 'stats_rolling_performance_vtrain7.png', dpi=150)
plt.show()
...
fig.tight_layout()
fig.savefig(FIGURES_DIR / 'stats_streaks_vtrain7.png', dpi=150)
plt.show()
